...
public class QueryData {
	 ...
	 * @param isExplain
	 *            a flag to determine if it is a explain query or not		          
	 */
	...
	/**
	 * Returns the flag indicating if it is a explain query or not.
	 * 
	 * @return a flag whether it is a explain query or not
	 */

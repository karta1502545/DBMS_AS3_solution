...
public class QueryData {
	...
	public QueryData(Set<String> projFields, Set<String> tables, Predicate pred,
			Set<String> groupFields, Set<AggregationFn> aggFn, List<String> sortFields, List<Integer> sortDirs, boolean toExplain) {
